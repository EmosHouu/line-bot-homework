...
// export const a  = async(event) => {
  ...
  try {
    ...
    // 簡介
    let info = ["兒時記憶裡的多多碰上熟後的蜜桃風味","經典熟成與整顆檸檬帶上清甜蜂蜜的尾韻","整顆鮮檸檬與經典紅茶清純爽口","桑椹莓果與經典熟成的邂逅","整顆鮮檸檬佐古法熬製的冬瓜露","香橙柑橘與莓果堆疊甘醇熟成沁入喉間","出於精煉的冬瓜，經歲月的火侯，成就獨有的韻味及香氣","清爽酸甜的蜂蜜與鮮切檸檬","清爽酸甜的柚子果肉與紅茶的絕配"]
